...
| Trust & Delegation | `agent-guild-trust` | AgentTanuki |
...
| Creative | `creative`, `marketing-demo`, `paper-marketing`, `slideshow-script`, `video-content`, `tiktok-slideshow`, `frontend-slides`, `app-store-screenshots`, `visual-style`, `image-gen`, `brand-kit-playground`, `remotion-best-practices`, `cmo-remotion`, `higgsfield-generate`, `higgsfield-soul-id`, `higgsfield-product-photoshoot` | MoizIbnYousaf |
