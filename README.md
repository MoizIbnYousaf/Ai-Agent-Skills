...
**One command. Every agent.** By default, skills install to Claude Code, Cursor, Codex, Amp, VS Code, Copilot, Gemini CLI, Kilo Code, Goose, Letta, OpenCode and QWen Code simultaneously.
...
Works with **Claude Code**, **Cursor**, **Codex**, **Amp**, **VS Code**, **GitHub Copilot**, **Gemini CLI**, **Kilo Code**, **Goose**, **Letta**, **OpenCode** and **QWen Code**.
