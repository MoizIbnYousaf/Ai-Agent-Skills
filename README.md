...
- Replaced the retired `frontend-skill` entry with `figma-implement-design`
- Expanded the `mktg` collection to 53 upstream skills
- Added `cmo-remotion` and `remotion-best-practices`
- Bundled library shipped 117 skills (17 house copies, 100 cataloged upstream)
